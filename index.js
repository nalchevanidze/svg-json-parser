...
function SVGJSONParser (){
  ...
  this.parse = function (d){ if(validElemenst.indexOf(d.nodeName) != -1) { return parse(d);}else{ throw new Error('Input Element is not Valid type;'); } };
...
module.exports = new SVGJSONParser();
